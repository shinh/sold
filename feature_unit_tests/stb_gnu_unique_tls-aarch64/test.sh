...
$(git rev-parse --show-toplevel)/build/sold -i libunique.so.original -o libunique.so.soldout --section-headers --check-output --custom-library-path /usr/aarch64-linux-gnu/lib
