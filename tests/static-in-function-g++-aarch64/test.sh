...
aarch64-linux-gnu-g++ -lpthread -Wl,--hash-style=gnu -shared -Wl,-soname,lib.so -o lib.so lib.o
aarch64-linux-gnu-g++ -Wl,--hash-style=gnu -o main.out main.cc lib.so -lpthread
